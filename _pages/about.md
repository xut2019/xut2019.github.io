...
3. **Xu T**, Zhang Z, Wang Y. Patch-wise skin segmentation of human body parts via deep neural networks[J]. **Journal of Electronic Imaging**, 2015, 24(4): 043009-043009.(SCI)
4. **Xu T**, Wang Y, Zhang Z. Pixel‐wise skin colour detection based on flexible neural tree[J]. **IET Image Processing**, 2013, 7(8): 751-761.(SCI)
...
# 🎖 Members
- **Faculty** : Feng Zhiquan(PI), Xu Tao, Wang Jing, Zhang Feng. 
- **Students**:
  Tian Qizong, Zhang Hao, Zhiyu Guo;
  Zheng Zhang, Xiaoyi Chen, Jiayin Zhang, Ruke Shang;
  Jiaqi Kong, Yiqun Niu.
